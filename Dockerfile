...
# Dependencies
RUN apt update && DEBIAN_FRONTEND=noninteractive apt install -y wget git php php-xml php-tokenizer nodejs curl php-pear neovim pgformatter python3 python3-pip dos2unix libxml2-utils xsel
